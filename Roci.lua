...
local function gettool()
    ...
    if remote then
        remote:FireServer("punch", "rightAttack")
        remote:FireServer("punch", "leftAttack")
		remote:FireServer("punch", "rightAttack")
        remote:FireServer("punch", "leftAttack")
		remote:FireServer("punch", "rightAttack")
        remote:FireServer("punch", "leftAttack")
...
local function farmRock(targetDurability)
    spawn(function()
        while getgenv().autoFarm do
            ...
            if char and char:FindFirstChild("rightAttack") and char:FindFirstChild("leftAttack") then
                local right = char.rightAttack
                local left = char.leftAttack
